...
const jurusanData = [
  { id: '01', name: 'Manajemen', jenjang: 'S1', fakultas: 'Fakultas Bisnis dan Manajemen', akreditasi: 'Unggul', deskripsi: 'Mengkaji pengelolaan sumber daya organisasi secara strategis untuk tantangan bisnis global.', icon: Landmark, href: '/prodi/manajemen' },
  { id: '02', name: 'Akuntansi', jenjang: 'S1', fakultas: 'Fakultas Bisnis dan Manajemen', akreditasi: 'Baik Sekali', deskripsi: 'Mempelajari audit, perpajakan, dan analisis laporan keuangan perusahaan secara mendalam.', icon: BookOpen, href: '/prodi/akuntansi' },
  { id: '03', name: 'Pariwisata', jenjang: 'S1', fakultas: 'Fakultas Bisnis dan Manajemen', akreditasi: 'Unggul', deskripsi: 'Mempelajari pengelolaan destinasi dan industri hospitality berstandar internasional.', icon: Globe, href: '/prodi/pariwisata' },
  { id: '04', name: 'Sistem Informasi', jenjang: 'S1', fakultas: 'Fakultas Ilmu Komputer', akreditasi: 'Baik Sekali', deskripsi: 'Mengintegrasikan teknologi informasi dengan proses bisnis dan manajemen organisasi modern.', icon: Monitor, href: '/prodi/sistem-informasi' },
  { id: '05', name: 'Teknologi Informasi', jenjang: 'S1', fakultas: 'Fakultas Ilmu Komputer', akreditasi: 'Baik Sekali', deskripsi: 'Mempelajari pengembangan perangkat lunak, algoritma, dan teknologi digital masa depan.', icon: GraduationCap, href: '/prodi/teknologi-informasi' },
  { id: '06', name: 'Teknik Sipil', jenjang: 'S1', fakultas: 'Fakultas Teknik Sipil dan Perencanaan', akreditasi: 'Unggul', deskripsi: 'Mempelajari perancangan, konstruksi, dan pemeliharaan infrastruktur bangunan modern.', icon: Building2, href: '/prodi/teknik-sipil' },
  { id: '07', name: 'Arsitektur', jenjang: 'S1', fakultas: 'Fakultas Teknik Sipil dan Perencanaan', akreditasi: 'Baik Sekali', deskripsi: 'Memadukan seni dan teknologi dalam merancang ruang bangunan yang fungsional dan estetis.', icon: Building2, href: '/prodi/arsitektur' },
  { id: '08', name: 'Ilmu Hukum', jenjang: 'S1', fakultas: 'Fakultas Hukum', akreditasi: 'Baik Sekali', deskripsi: 'Mengkaji sistem hukum nasional dan internasional serta penegakan keadilan masyarakat.', icon: Scale, href: '/prodi/ilmu-hukum' },
  { id: '09', name: 'Pendidikan Bahasa Inggris', jenjang: 'S1', fakultas: 'Fakultas Ilmu Pendidikan', akreditasi: 'Baik Sekali', deskripsi: 'Mengembangkan kompetensi pengajaran bahasa Inggris profesional dengan metode modern.', icon: Languages, href: '/prodi/pendidikan-bahasa-inggris' },
  { id: '10', name: 'Biologi', jenjang: 'S1', fakultas: 'Fakultas Kesehatan dan Sains', akreditasi: 'Baik Sekali', deskripsi: 'Mengeksplorasi ilmu hayati dan bioteknologi untuk solusi kesehatan dan lingkungan.', icon: Dna, href: '/prodi/biologi' },
  { id: '11', name: 'Gizi', jenjang: 'S1', fakultas: 'Fakultas Kesehatan dan Sains', akreditasi: 'Baik Sekali', deskripsi: 'Mempelajari ilmu gizi, dietetika, dan kesehatan masyarakat untuk gaya hidup sehat.', icon: Utensils, href: '/prodi/gizi' },
  { id: '12', name: 'Kedokteran', jenjang: 'S1', fakultas: 'Fakultas Kedokteran', akreditasi: 'Baik Sekali', deskripsi: 'Menempuh pendidikan medis untuk menjadi praktisi kesehatan profesional dan berintegritas.', icon: HeartPulse, href: '/prodi/kedokteran' },
]
