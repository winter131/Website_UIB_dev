...
export default function NewsDetailView({ news, latestNews, slug }: NewsDetailViewProps) {
        ...
        <>
            ...
            <div className="container mx-auto px-6 md:px-20 max-w-6xl">
                <nav className="mb-10">
                    ...
                    >
                        <FaChevronLeft size={8} className="transition-transform group-hover:-translate-x-1" /> Kembali ke Berita
                    </Link>
                </nav>
                ...
                <div className="mb-12">
                    ...
                    <div className="flex items-center gap-4 text-slate-500 text-xs py-6 border-y border-slate-100">
                        ...
                        <div>
                            <p className="text-[10px] uppercase font-black tracking-widest text-[#2A3955] mb-0.5">Ditulis oleh</p>
                    ...
                    <article className="lg:col-span-8">
                        ...
                        <div className="mt-24 pt-12 border-t border-slate-100">
                            <div className="flex flex-wrap items-center justify-between gap-6">
                                <div>
                                    <h4 className="text-[#1A253A] font-black text-[10px] uppercase tracking-[0.2em] mb-4">Kategori Terkait</h4>
                        ...
                        <div className="sticky top-32 space-y-16">
                            ...
                            <div className="relative p-8 rounded-3xl bg-[#1A253A] overflow-hidden group shadow-2xl shadow-slate-300">
                                ...
                                <h5 className="relative z-10 text-white font-black text-lg leading-tight mb-4">
                                    Temukan lebih banyak berita dari UIB
                                </h5>
                                <p className="relative z-10 text-slate-400 text-xs font-light leading-relaxed mb-8">
                                    Jelajahi pencapaian terbaru, kehidupan mahasiswa, dan keunggulan akademik di Kota Batam.
                                </p>
                                <Link
                                    href="/berita"
                                ...
                                >
                                    Lihat Semua Berita <FaArrowRight size={10} />
                                </Link>
                            </div>
                        </div>
                    </aside>
