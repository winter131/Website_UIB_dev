...
import DosenFh from '@/components/landing/direktoridosen/dosenfh'

export default function DirektoriFhView() {
    return (
            ...
            <section className="pt-40 pb-16 bg-slate-50 border-b border-slate-100 relative overflow-hidden">
                ...
                <div className="container mx-auto px-6 md:px-20 relative z-10">
                    <div className="max-w-4xl">
                        <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-emerald-100/50 border border-emerald-200 text-[#1a365d] text-[10px] font-black uppercase tracking-widest mb-6 shadow-sm">
                            <Scale size={12} /> Fakultas Hukum
                        </div>
                        <h1 className="text-4xl md:text-5xl font-black text-[#1a365d] mb-6 leading-tight tracking-tight">
                            Direktori <span className="text-[#f6a623]">Dosen Hukum</span>
                        </h1>
                        <p className="text-slate-500 text-sm md:text-base leading-relaxed max-w-2xl">
                            Daftar tenaga pendidik profesional pada Fakultas Hukum Universitas Internasional Batam.
                        </p>
                    </div>
                </div>
            </section>
