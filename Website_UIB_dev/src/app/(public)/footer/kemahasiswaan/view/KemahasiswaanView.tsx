           ...
           {/* 1. HERO IMAGE SECTION - ENHANCED WITH OVERLAY */}
            ...
            <section className="bg-[#2A3955] py-16 text-white text-center relative overflow-hidden">
                ...
                <div className="relative z-10 max-w-2xl mx-auto px-6">
                    ...
                    <Link href="/" className="inline-block bg-[#f1c40f] text-[#2A3955] px-10 py-4 rounded-xl font-black text-xs uppercase tracking-widest hover:bg-white transition-all shadow-lg">
                        Jelajahi UIB
                    </Link>
                </div>
            </section>
