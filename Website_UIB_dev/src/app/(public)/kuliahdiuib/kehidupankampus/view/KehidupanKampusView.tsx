...
export default function KehidupanKampusView() {
    return (
        <main className="min-h-screen bg-white font-poppins selection:bg-[#2A3955] selection:text-white">
            ...
            <div className="relative z-20 w-full -mt-20 md:-mt-16">
                <div className="container mx-auto px-6 md:px-12 lg:px-24">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-4">
                        {[
                            { title: "Fasilitas", desc: "Info lebih lanjut tentang fasilitas Universitas Internasional Batam", img: "/img/DSC06279.jpg" },
                            { title: "Batam dan Sekitarnya", desc: "Info lebih lanjut tentang Kota Batam dan sekitarnya", img: "/img/C1700307.jpg" },
                            { title: "Diskon Mahasiswa", desc: "Info lebih lanjut tentang detail Discount Card UIB", img: "/img/Gp.jpg" }
                        ].map((card, i) => (
                            <motion.div
                                key={i}
                                whileHover={{ y: -5 }}
            ...
            {/* 3. FASILITAS UIB SECTION (NAVY BG) */}
