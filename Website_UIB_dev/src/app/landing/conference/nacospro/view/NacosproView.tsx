                    ...
                    <div className="flex flex-col lg:grid lg:grid-cols-12 gap-16 items-center">
                        ...
                        <div className="lg:col-span-12 flex flex-col md:flex-row md:items-center justify-between border-b border-slate-100 pb-6 mb-4">
                            <Link
                                ...
                                className="flex items-center gap-3 text-[10px] font-bold tracking-[0.4em] text-[#e67e22] group"
                            >
                                <span className="group-hover:-translate-x-1 transition-transform">←</span> BACK TO DIRECTORY
                            </Link>
                            <div className="flex items-center gap-3 mt-4 md:mt-0 font-bold uppercase tracking-[0.2em] text-[#2A3955]/30 text-[10px]">
                        ...
                        <div className="lg:col-span-6">
                            ...
                            >
                                <div className="space-y-4">
                                    <span className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-slate-100 text-[#2A3955] text-[10px] font-black tracking-widest uppercase">
                                        <span className="w-2 h-2 rounded-full bg-[#e67e22]"></span>
                                        The 7th Series
                                    </span>
                                    <h1 className="text-6xl md:text-7xl lg:text-8xl font-black tracking-tighter leading-none text-[#2A3955]">
                                        NaCos<span className="text-[#e67e22]">Pro</span>
                                        <span className="block text-4xl md:text-5xl mt-2 text-slate-300">2025</span>
                                    </h1>
                                </div>

                                <div className="max-w-md space-y-6">
                                    <h4 className="text-lg md:text-xl font-bold text-[#2A3955]/80 leading-snug">
                                        20 Agustus 2025
                                    </h4>
                                    <p className="text-slate-400 font-medium leading-relaxed italic border-l-2 border-[#e67e22] pl-5 text-sm">
                                        "National Conference For Community Service Project"
                                    </p>
                                </div>
                            </motion.div>
                        </div>
                                    ...
                                    <div className="flex flex-col md:flex-row">
                                        ...
                                        <div className="bg-[#2A3955] md:w-32 flex flex-row md:flex-col items-center justify-center p-6 text-white gap-4 md:gap-2">
                                            ...
                                            <div className="flex flex-col items-start md:items-center">
                                                <span className="text-[10px] font-bold uppercase tracking-widest opacity-60">Aug</span>
                                                <span className="text-[10px] font-bold uppercase tracking-widest opacity-60">2025</span>
                                            </div>
                                        </div>
                                        ...
                                        <div className="flex-1 p-8 md:p-10 space-y-8">
                                            <div className="flex flex-wrap items-center gap-4 justify-between">
                                                <div className="space-y-1">
                                                    <p className="text-[10px] font-black text-[#e67e22] uppercase tracking-[0.2em]">Global Event</p>
                                                    <h3 className="text-xl font-bold text-[#2A3955]">Schedule Overview</h3>
                                                </div>
                                                <div className="flex items-center gap-2 py-1.5 px-3 bg-green-50 rounded-lg">
                                                    <div className="w-1.5 h-1.5 bg-green-500 rounded-full animate-pulse"></div>
                                                    <span className="text-[9px] font-black text-green-700 uppercase tracking-wider">Live Virtual</span>
                                                </div>
                                            </div>
                                            ...
                                            <div className="grid gap-6">
                                                ...
                                                <div className="flex gap-4 group/item">
                                                    ...
                                                    <div>
                                                        <p className="text-[9px] font-black text-slate-300 uppercase tracking-widest mb-0.5">Host Center</p>
                                                        <p className="text-[#2A3955] font-bold text-sm">Tunghai University, Taiwan</p>
                                                    </div>
                                                </div>
                                                ...
                                                <div className="flex gap-4 group/item">
                                                    ...
                                                    <div>
                                                        <p className="text-[9px] font-black text-slate-300 uppercase tracking-widest mb-0.5">Secretariat</p>
                                                        <p className="text-slate-500 font-medium text-xs leading-snug">Kota Batam, Kepulauan Riau, Indonesia</p>
                                                    </div>
                                                </div>
                                            </div>

                                            <button className="group w-full py-4 bg-[#2A3955] hover:bg-[#e67e22] text-white rounded-2xl font-black text-[10px] uppercase tracking-[0.3em] transition-all flex items-center justify-center gap-3 overflow-hidden">
