      ...
      <div className="flex flex-col md:flex-row min-h-[600px]">
        ...
        <div className="w-full md:w-1/2 bg-[#2A3955] p-10 md:p-20 text-white flex flex-col justify-center">
          ...
          <div className="space-y-6 opacity-90 text-[14px] md:text-[15px] leading-relaxed mb-12">
            <p>
              Universitas Internasional Batam (UIB) berkomitmen untuk menyiapkan pemimpin dan profesional masa depan serta mendorong inovasi demi terwujudnya masyarakat yang sejahtera, demokratis, dan berkeadilan.
            </p>
            <p>
              UIB terus bergerak menuju organisasi yang memiliki daya saing tinggi, bukan hanya pada skala lokal, namun juga pada skala regional bahkan internasional.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 gap-y-10 gap-x-6">
            <div>
              <div className="text-2xl md:text-3xl font-bold mb-1">29.638 <span className="text-sm font-normal">orang</span></div>
              <div className="text-[11px] uppercase tracking-wider opacity-70 font-medium">Penerima Beasiswa</div>
            </div>
            <div>
              <div className="text-2xl md:text-3xl font-bold mb-1">58.444 <span className="text-sm font-normal">orang</span></div>
              <div className="text-[11px] uppercase tracking-wider opacity-70 font-medium">Lulusan Mahasiswa</div>
            </div>
            <div>
              <div className="text-2xl md:text-3xl font-bold mb-1">3.460 <span className="text-sm font-normal">judul</span></div>
              <div className="text-[11px] uppercase tracking-wider opacity-70 font-medium">Riset Terpublikasi</div>
            </div>
            <div>
              <div className="text-2xl md:text-3xl font-bold mb-1">28.218 <span className="text-sm font-normal">orang</span></div>
          ...
          <div className="mt-12">
            <button className="border-2 border-white px-8 py-3 text-[11px] font-bold tracking-[0.2em] uppercase hover:bg-white hover:text-[#e67e22] transition-all">
              <a href='#targer'>Lihat Lebih Lanjut</a>
            </button>
          </div>
        </div>
