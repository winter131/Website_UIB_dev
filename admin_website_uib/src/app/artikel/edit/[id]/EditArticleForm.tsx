...
export default function EditArticleForm({ initialData }: { initialData: any }) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // Gunakan API berita yang sudah berjalan (data tersimpan di tabel yang sama)
        ...
        <form onSubmit={handleSubmit} className="bg-white p-8 rounded-xl shadow-sm border border-gray-100 space-y-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                    <label className="text-sm font-semibold text-gray-700">Judul Artikel (Title) *</label>
                    <input
                        type="text"
                        name="title"
                        required
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                    <label className="text-sm font-semibold text-gray-700">Sub-Kategori Artikel *</label>
                    <select
                        name="category"
                        required
            ...
            <div className="space-y-2">
                <label className="text-sm font-semibold text-gray-700">Isi Artikel Lengkap (Description) *</label>
            ...
            <div className="flex items-center justify-end gap-4 pt-6 border-t border-gray-100">
                <Link href="/artikel" className="px-6 py-2.5 text-gray-600 font-medium hover:bg-gray-100 rounded-lg transition-colors">
                    Batal
                </Link>
                <button
                    type="submit"
