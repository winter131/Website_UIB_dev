...
import type { news as NewsType } from '@/generated/client';
    ...
    return (
        <div className="space-y-6">
            <div className="flex justify-between items-center">
                ...
                <Link href="/berita/buat" className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg font-medium transition-colors">
                    Tambah Berita
                </Link>
            </div>
                        ...
                        {newsList.length === 0 ? (
                            ...
                            newsList.map((newsItem: NewsType) => (
                                <tr key={newsItem.id} className="hover:bg-gray-50 transition-colors">
                                    ...
                                    <td className="p-4">
                                        <span className="px-2 py-1 bg-green-100 text-green-700 rounded-md text-xs font-medium">Terbit</span>
                                    </td>
