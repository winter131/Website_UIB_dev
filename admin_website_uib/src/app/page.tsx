...
import { Newspaper, FileText, Globe, ArrowUpRight, Plus, Award } from "lucide-react";
...
export default async function Dashboard() {
  ...
  const totalPrestasi = await prisma.news.count({ where: { category: 'Prestasi' } });
  const totalBerita = totalAll - totalArticle - totalPrestasi;
  const stats = [
    {
      label: "Total Konten",
      value: totalAll,
    ...
    },
    {
      ...
      color: "bg-orange-500",
      textColor: "text-orange-600",
      description: "Mahasiswa Berprestasi"
    },
  ];
