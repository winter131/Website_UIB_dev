...
export function NotionEditorHeader() {
  return (
    <header className="notion-like-editor-header flex items-center gap-2 px-4 py-2 border-b bg-white sticky top-0 z-10 min-h-[50px]">
      ...
      <div className="notion-like-editor-header-actions flex items-center gap-2 px-2">
         <span className="text-[10px] text-slate-400 font-medium italic uppercase tracking-wider">Rich Text Editor</span>
      </div>
    </header>
  )
}
