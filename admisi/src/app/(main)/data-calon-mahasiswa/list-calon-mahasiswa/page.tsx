...
import ListCalonMahasiswaView from "./view/ListCalonMahasiswaView";

export default function ListCalonMahasiswa() {
  ...
  return !isLoading && isFetched ? (
    <>{permission ? <ListCalonMahasiswaView /> : <NotAllowedPage />}</>
  ) : (
    <LoadingPermission />
  );
}
