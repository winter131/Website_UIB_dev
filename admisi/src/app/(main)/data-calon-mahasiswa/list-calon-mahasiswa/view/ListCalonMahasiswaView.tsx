...
export default function ListCalonMahasiswaView() {
  ...
  useEffect(() => {
    const saved = localStorage.getItem("appliedFilterListCalonMahasiswa");
    const search = localStorage.getItem("appliedSearchListCalonMahasiswa");
    if (saved) {
  ...
  useEffect(() => {
    ...
    localStorage.setItem(
      "appliedFilterListCalonMahasiswa",
      JSON.stringify({
    ...
    localStorage.setItem("appliedSearchListCalonMahasiswa", searchTerm);
    ...
    <div className="px-8 py-4">
      ...
      <div className="breadcrumbs text-sm text-black">
        <ul>
          ...
          <li className="text-xs">
            <Link href={pathname}>List Calon Mahasiswa</Link>
          </li>
        </ul>
      </div>
      ...
      <div className="mt-2 flex flex-wrap gap-4">
        <span className="font-normal text-black">
          Modul untuk melihat dan mencetak data finansi calon mahasiswa
        </span>
      </div>
