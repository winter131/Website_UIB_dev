...
import PerubahanGelombangView from "./view/PerubahanGelombangView";

export default function PerubahanGelombang() {
  ...
  return !isLoading && isFetched ? (
    <>{permission ? <PerubahanGelombangView /> : <NotAllowedPage />}</>
  ) : (
    <LoadingPermission />
  );
}
