...
import RekapPerubahanProdiView from "./view/RekapPerubahanProdiView";

export default function RekapPerubahanProdi() {
  ...
  return !isLoading && isFetched ? (
    <>{permission ? <RekapPerubahanProdiView /> : <NotAllowedPage />}</>
  ) : (
    <LoadingPermission />
  );
}
