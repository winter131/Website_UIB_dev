...
import { useCreateInformasiUmum } from "@/hooks/informasi-umum/useCreateInformasiUmum";
import { isTiptapEmpty } from "@/utils/isTiptapEmpty";

export default function TambahInformasiView() {
  ...
  const { mutate: createInformasiUmumMutation } = useCreateInformasiUmum(
    () => {
      showNotification({
        status: "text-green-500",
        icon: "bx bx-check text-2xl",
        header: "Berhasil",
        message: "Berhasil menambahkan informasi umum",
      });
      setInformasiUmum({
        id_informasi: "",
        judul_informasi: "",
  ...
  return (
    <div className="px-8 py-4">
      <h1 className="w-full text-4xl font-bold text-black">
        Informasi Umum - Tambah Informasi
      </h1>
      ...
      <div className="breadcrumbs text-sm text-black">
        <ul>
          ...
          <li className="text-xs">
            <Link href={pathname}>Tambah Informasi</Link>
          </li>
        </ul>
      </div>
            ...
            <button
              ...
              onClick={() =>
                showConfirmation({
                  ...
                  message:
                    "Anda yakin ingin me-reset form informasi ini? Data yang telah tambahkan akan hilang.",
                  onConfirm: () => {
