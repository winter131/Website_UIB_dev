...
export const columns: ColumnDef<JurusanSMTAType>[] = [
  {
    id: "search",
    accessorFn: (row) =>
      [row.jurusan_nama, row.jurusan_id].join(" ").toLowerCase(),
    header: () => null,
    cell: ({ row }) => null,
    enableHiding: true,
  },
  ...
  {
    accessorKey: "jurusan_nama",
    header: () => (
      <div className="text-black dark:text-white font-bold">Nama Jurusan</div>
    ),
  },
  {
    id: "action",
