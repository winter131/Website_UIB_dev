...
export const columns: ColumnDef<KotaType>[] = [
  {
    id: "search",
    accessorFn: (row) =>
      [row.nama_kota, row.ProvinsiName].join(" ").toLowerCase(),
    header: () => null,
    cell: ({ row }) => null,
    enableHiding: true,
  },
  ...
  },
  {
    accessorKey: "id_kota",
    header: () => (
      <div className="text-black dark:text-white font-bold">Kode Kota</div>
    ),
  },
  {
    accessorKey: "nama_kota",
    header: () => (
      <div className="text-black dark:text-white font-bold">Nama Kota</div>
    ),
  },
  {
    accessorKey: "ProvinsiName",
    header: () => (
