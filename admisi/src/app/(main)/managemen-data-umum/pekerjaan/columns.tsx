...
export const columns: ColumnDef<PekerjaanType>[] = [
  {
    id: "search",
    accessorFn: (row) => [row.nama_pekerjaan].join(" ").toLowerCase(),
    header: () => null,
    cell: ({ row }) => null,
    enableHiding: true,
  },
  ...
  },
  {
    ...
    header: () => (
      <div className="text-black dark:text-white font-bold">Pekerjaan</div>
    ),
  },
  {
    id: "action",
