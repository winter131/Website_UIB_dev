...
export const columns: ColumnDef<SekolahType>[] = [
  {
    id: "search",
    accessorFn: (row) =>
      [row.nama_sekolah, row.id_sekolah, row.KotaName].join(" ").toLowerCase(),
    header: () => null,
    cell: ({ row }) => null,
    enableHiding: true,
  },
  ...
  {
    accessorKey: "id_sekolah",

    header: () => (
      <div className="text-black dark:text-white font-bold">Kode Sekolah</div>
    ),
  },
  {
    accessorKey: "nama_sekolah",
    header: () => (
      <div className="text-black dark:text-white font-bold">Nama Sekolah</div>
    ),
  },
  {
