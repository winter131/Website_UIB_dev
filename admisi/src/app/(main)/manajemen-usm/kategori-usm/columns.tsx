...
export const columns: ColumnDef<KategoriUSMType>[] = [
  {
    id: "search",
    accessorFn: (row) =>
      [row.nama_kategori, row.TotalSoal, row.TotalSoal + " Soal"]
        .join(" ")
        .toLowerCase(),
    header: () => null,
    cell: ({ row }) => null,
  ...
  },
  {
    ...
    header: () => (
      <div className="text-black dark:text-white font-bold">Kategori Soal</div>
    ),
  },
  {
    accessorKey: "TotalSoal",
    header: () => (
