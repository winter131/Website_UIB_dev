...
interface DataTableProps<TData, TValue> {
  ...
  refetch?: () => void;
  searchQuery?: string;
  handleResetWaktuSelesai?: (data: any) => void;
  handleHapusDataMengikuti?: (data: any) => void;
}
...
export function DataTable<TData, TValue>({
  ...
  refetch,
  searchQuery,
  handleResetWaktuSelesai,
  handleHapusDataMengikuti,
            ...
            <>
              {table.getRowModel().rows.length ? (
                ...
                <TableRow>
                  ...
                  >
                    Data tidak ditemukan. Coba lagi atau pilih sesi ujian
                    lainnya.
