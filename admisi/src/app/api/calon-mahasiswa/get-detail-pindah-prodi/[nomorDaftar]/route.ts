...
export async function GET(
  ...
  try {
    const endpoint =
      isKepala === "true"
        ? `/v2/calon-mahasiswa/detail-pindah-prodi/${nomorDaftar}/y`
        : `/v2/calon-mahasiswa/detail-pindah-prodi/${nomorDaftar}/n`;
    ...
    if (res.data.status === 200) {
      ...
      return NextResponse.json(
        {
          message: res.data.error || "Gagal mengambil data detail pindah prodi",
        },
        { status: 500 },
      );
    }
