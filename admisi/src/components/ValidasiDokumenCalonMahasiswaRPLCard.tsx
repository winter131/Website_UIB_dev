...
interface ValidasiDokumenCalonMahasiswaRPLCardProps {
...
export default function ValidasiDokumenCalonMahasiswaRPLCard({
  data,
  isLoading = false,
}: ValidasiDokumenCalonMahasiswaRPLCardProps) {
  ...
  const canValidate =
    data.StatusBiodataCamhs === "w" && data.StatusDokumenCamhs === "w";

  const alreadyValidated =
    data.StatusBiodataCamhs === "y" || data.StatusBiodataCamhs === "n";

  const isDitolak = data.StatusBiodataCamhs === "n";
      ...
      <div className="w-full bg-white rounded-xl shadow-sm overflow-hidden border border-slate-200">
        ...
        <div className="border-t border-slate-200 p-6">
          <div className="flex flex-col sm:flex-row gap-3 justify-end">
            <Link
              href={`/rekognisi-pembelajaran-lampau/validasi-dokumen/${data.NomorDaftar}/${data.NamaCamhs}`}
